...
class Tracker:
    ...
    def run_video(self, videofilepath, idx = 0, tracking_thresh = 0.9, optional_box=None, debug=None, visdom_info=None, save_results=False):
        ...
        while True:
            ...
            if tracking:
                ...
                print(out)
                if start_idx is None and out['conf_score'] >= tracking_thresh:
                ...
                if start_idx is not None and out['conf_score'] < tracking_thresh:
